...
export default function ClassroomPage() {
  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-[#2d3e30]">
      ...
      {/* Whiteboard Area */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[60%] w-[800px] h-[500px] bg-[#1a261d] border-[16px] border-[#8d6e63] rounded-lg shadow-2xl z-10 flex flex-col overflow-y-auto">
        {/* Chalk tray */}
